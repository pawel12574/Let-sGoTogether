...
(function (window, document) {
    ...
    angular.module('vsGoogleAutocomplete').directive('vsGoogleAutocomplete', ['vsGooglePlaceUtility', '$timeout', function(vsGooglePlaceUtility, $timeout, $scope) {
      return {
        restrict: 'A',
        ...
        link: function(scope, element, attrs, ctrls) {
    			...
    			if(element[0].id==="from"){
    				document.getElementById('fromLat').value=vsGooglePlaceUtility.getLatitude(place);
    				document.getElementById('fromLng').value=vsGooglePlaceUtility.getLongitude(place);
    			  }else{
    				document.getElementById('toLat').value=vsGooglePlaceUtility.getLatitude(place);
  				    document.getElementById('toLng').value=vsGooglePlaceUtility.getLongitude(place);
  				    }
