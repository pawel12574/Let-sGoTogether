...
public class UserController {
    ...
    public @ResponseBody
    User checkEmail(@RequestBody EmailDto email) {
    ...
    public ResponseEntity<String> createUser(@RequestBody UserDto userDto) {
        ...
        String url = server.getServerPath() + "/user/activate/" + token + "";
            ...
            emailService.sendMail("lgtwipb@gmail.com",
                    user.getUsername(),
                    "Let'sGoTogether",
                    "Kliknij w link, aby aktywować konto " + url + "");
    ...
    public String changePassword(@RequestParam Long id, @RequestParam String token) throws Exception {
    ...
    public ResponseEntity<String> setUserRole(@PathVariable Long userId) {
    ...
    public ResponseEntity<String> changePrivileges(@PathVariable Long userId) {
